...
@section('content')
    ...
    <!-- Main content -->
  <form action="{{route('guardacambiosG')}}" method="POST">
    {{csrf_field()}}
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" name="idgen" id="idgen" value="{{$consulta->idgen}}" readonly="readonly">
                  </div>
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control" name="genero" id="genero" value="{{$consulta->genero}}" placeholder="Genero">
                  </div>
                </div>
                <div class="row">
