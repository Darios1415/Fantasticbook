...
@section('content')
    ...
    <!-- Main content -->
  <form action="{{route('guardacambiosSG')}}" method="POST">
    {{csrf_field()}}
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" name="idsubgen" id="idsubgen" value="{{$consulta->idsubgen}}" readonly="readonly">
                  </div>
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control" name="subgenero" id="subgenero" value="{{$consulta->subgenero}}" placeholder="Subgénero">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="idgen">Género:</label>
                    <select name="idgen" id="idgen" class="form-control">
                      <option selected="" value="{{$consulta->idsubgen}}">{{$consulta->gen}}</option>
